...
# Example
An example of u-blox receiver dataset collected from [Kowloon Bay, Hong Kong](https://www.google.com/maps/place/%E4%B9%9D%E9%BE%99%E6%B9%BE/@22.3207264,114.2052806,16z/data=!4m6!3m5!1s0x34040139ce5cb28d:0xebb076fb9d3032f4!8m2!3d22.3080749!4d114.2018982!16zL20vMDIyeng3?entry=ttu) has been provided in the repository. The data files to support full code execution are available at the example EnvFolder at "EnvFolder.zip" in the [release 1](https://github.com/ZhengdaoLI0602/GNSS_INS_Integrations_Comparisons/releases/tag/EnvFolder). For your further analysis, please find the raw GNSS observation, ephemeris, and ground truth files at "Raw.files.zip" in the [release 2](https://github.com/ZhengdaoLI0602/GNSS_INS_Integrations_Comparisons/releases/tag/RawFiles). The collection was done by group in [Intelligent Positioning And Navigation Laboratory](https://github.com/IPNL-POLYU) using similar standards with [UrbanNav dataset](https://github.com/IPNL-POLYU/UrbanNavDataset). The target outcomes are depicted in the following plots and stored in folder "Target Plots".
- Summary
  ||KF|AKF|FGO|AFGO|
  |---|---|---|---|---|
