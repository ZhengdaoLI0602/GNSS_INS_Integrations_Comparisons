...
# Example
An example of u-blox receiver dataset collected from Kowloon Bay, Hong Kong has been provided in the repository. The collection was done by group in [Intelligent Positioning And Navigation Laboratory](https://www.polyu-ipn-lab.com/) using similar standards with [URBANNAV dataset](https://www.polyu-ipn-lab.com/urbannav). The target outcomes are shown in the following plots, given in folder "Target Plots".
- Summary
  ||KF|AKF|FGO|AFGO|
  |---|---|---|---|---|
