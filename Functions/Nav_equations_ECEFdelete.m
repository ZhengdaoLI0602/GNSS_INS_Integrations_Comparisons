function [r_eb_e,v_eb_e,C_b_e,f_ib_e_debug] = Nav_equations_ECEFdelete(tor_i,old_r_eb_e,...
...
f_ib_e_debug =(f_ib_e + Gravity_ECEF(old_r_eb_e) -2 * Skew_symmetric([0;0;omega_ie]) * old_v_eb_e);
