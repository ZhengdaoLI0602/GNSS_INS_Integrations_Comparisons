...
R_matrix(1:3,1:3) = eye(3) * adaptiveR.^2;
% if lack_gnss_data == 1 && whether_adaptive == 1
%     R_matrix(1:3,1:3) = eye(3) * 200.^2;
% end
...
est_C_b_e_new = (eye(3) - Skew_symmetric(x_est_new(1:3))*1/2) * est_C_b_e_old;
