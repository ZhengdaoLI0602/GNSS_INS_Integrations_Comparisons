function [dtR, var_dtR, bad_obs, bad_epoch, sigma02_hat, residuals_obs, is_bias] = LS_SA_code_clock_Qmo2(pr_R, snr_R, elR, distR, dtS, err_tropo_RS, err_iono_RS, sys, SPP_threshold)
